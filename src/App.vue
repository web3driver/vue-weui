...
<style>
  ...
  .page.layers .layers__layer {
    ...
    transition: .5s;
    background: url(pages/images/layers/transparent.gif) no-repeat 50%;
  ...
  .page.layers .layers__layer_popout.j_pic {
    ...
    background-image: url(pages/images/layers/popout.png)
  }
  ...
  .page.layers .layers__layer_navigation.j_pic {
    ...
    background-image: url(pages/images/layers/navigation.png)
  }
  ...
  .page.layers .layers__layer_content.j_pic {
    background-image: url(pages/images/layers/content.png)
  }
